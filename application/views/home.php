            ...
            <div class="row">
              <div class="col-md-10 col-lg-7">
                <div class="box-animation">
                  ...
                  <div class="button-block" data-caption-animate="fadeInUp" data-caption-delay="450"><a class="button button-primary-gradient" href="<?= base_url('auth')?>"><span>Login Alumi</span></a></div>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="container">
    ...
    <div class="row row-30 justify-content-center">
      ...
      <div class="col-sm-10 col-md-6 wow fadeIn">
        <!-- Post Light--><a class="post-light context-dark" href="#" style="background-image: url( <?= base_url('src/Pages/images/'.$n['image']) ?> );">
          <div class="post-light-inner">
            <div class="badge">News</div>
            <div class="post-light-main">
              <time class="post-light-time" datetime="2019"><?= date('Y/d/m',$n['date']) ?></time>
              <h4 class="post-light-title"><?= $n['title'] ?></h4>
            </div>
          </div></a>
      </div>
      <?php endforeach; ?>
